...
class AT_Meta_Box {
  ...
  public function check_field_select() {
    ...
    if ( ! $this->has_field( 'select' ))
      ...
      wp_enqueue_style('at-multiselect-select2-css', get_stylesheet_directory_uri() . '/admin/js/select2/select2.css', array(), null);
      wp_enqueue_script('at-multiselect-select2-js', get_stylesheet_directory_uri() . '/admin/js/select2/select2.js', array('jquery'), false, true);
  }
  ...
  public function check_field_code() {
    ...
    if ( $this->has_field( 'code' ) && $this->is_edit_page() ) {
      ...
      wp_enqueue_style( 'at-code-css', get_stylesheet_directory_uri() . '/admin/js/codemirror/codemirror.css',array(),null);
      wp_enqueue_style( 'at-code-css-dark', get_stylesheet_directory_uri() . '/admin/js/codemirror/solarizedDark.css',array(),null);
      wp_enqueue_style( 'at-code-css-light', get_stylesheet_directory_uri() . '/admin/js/codemirror/solarizedLight.css',array(),null);
      wp_enqueue_script('at-code-js', get_stylesheet_directory_uri() . '/admin/js/codemirror/codemirror.js',array('jquery'),false,true);
      wp_enqueue_script('at-code-js-xml', get_stylesheet_directory_uri() . '/admin/js/codemirror/xml.js',array('jquery'),false,true);
      wp_enqueue_script('at-code-js-javascript', get_stylesheet_directory_uri() . '/admin/js/codemirror/javascript.js',array('jquery'),false,true);
      wp_enqueue_script('at-code-js-css', get_stylesheet_directory_uri() . '/admin/js/codemirror/css.js',array('jquery'),false,true);
      wp_enqueue_script('at-code-js-clike', get_stylesheet_directory_uri() . '/admin/js/codemirror/clike.js',array('jquery'),false,true);
      wp_enqueue_script('at-code-js-php', get_stylesheet_directory_uri() . '/admin/js/codemirror/php.js',array('jquery'),false,true);
  ...
  public function show_field_repeater( $field, $meta ) {
    ...
    $meta = get_post_meta($post->ID,$field['id'],true);
      ...
      if (count($meta) > 0 && is_array($meta) ){
        ...
        <span class="re-control"><img src="'.$plugin_path.'/images/remove.png" alt="'.__('Remove','asteria').'" title="'.__('Remove','asteria').'" id="remove-'.$field['id'].'"></span>
    ...
    echo '" alt="'.__('Add','asteria').'" title="'.__('Add','asteria').'" id="add-'.$field['id'].'"><br/></div>';
    ...
    echo '</table><img src="'.$plugin_path.'/images/remove.png" alt="'.__('Remove','asteria').'" title="'.__('Remove','asteria').'" id="remove-'.$field['id'].'"></div>';
  ...
  function Validate_upload_file_type($file) {
    if (isset($_POST['uploadeType']) && !empty($_POST['uploadeType']) && isset($_POST['uploadeType']) && $_POST['uploadeType'] == 'my_meta_box'){
      ...
      if (!in_array($ext, (array)$allowed)){
        $file['error'] = __("Sorry, you cannot upload this file type for this field.", "asteria");
        return $file;
      }
