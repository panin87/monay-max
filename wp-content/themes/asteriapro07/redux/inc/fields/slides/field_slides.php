            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    if ($slide['slide_title'] != '' && isset($slide['slide_title'])) {
                        ...
                        echo '<li><input placeholder="'.__('Link', 'redux-framework').'" type="text" id="' . $this->field['id'] . '-slide_url_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][slide_url]" value="' . esc_attr($slide['slide_url']) . '" class="full-text" /></li>';
						//New Field by Towfiq: 
