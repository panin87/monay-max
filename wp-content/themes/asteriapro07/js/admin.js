...
jQuery(window).ready(function() {
	...
	jQuery('.tr_asteria-map_title_id, .tr_asteria-map_latlong_id, .tr_asteria-map_textarea_id').addClass('ast_map');
	jQuery('.tr_asteria-call_textarea_id, .tr_asteria-call_text_id, .tr_asteria-call_url_id, .tr_asteria-callbg_color_id, .tr_asteria-callbttn_color_id, .tr_asteria-callbttntext_color_id').addClass('ast_callaction');
	jQuery('#2_section_group #widget-info').addClass('ast_frntwdgt');
		
	jQuery(".ast_frntwdgt, .ast_posts, .ast_map, .ast_callaction, .ast_welcome").hide();
